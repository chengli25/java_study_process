...
public class CustomerBaseDAOImplTest {
    ...
    public void insert() {
        ...
        try {
            ...
            Customer cust = new Customer(1, "万语语", "wanyu@.com", new Date(4405727584302L),null);
    ...
    public void updateById() {
        ...
        try {
            conn = JDBCUtils.getConnection();
            Customer cust = new Customer(63, "万语", "wanyu@.com", new Date(),null);
    ...
    public void getCustomerById() throws SQLException, IOException, ClassNotFoundException {
        ...
        Customer cust = cbdi.getCustomerById(conn,64);
    ...
    @Test
    public  void getMinBirth() throws SQLException, IOException, ClassNotFoundException {
        Connection conn = null;
        conn = JDBCUtils.getConnection();
        Date date = cbdi.getMinBirth(conn);
        System.out.println("最小的生日为：" + date);
