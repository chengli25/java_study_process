 ...
 * @return
 **/
public class CustomerBaseDAOImpl extends baseDAO<Customer> implements customersDAO {
    ...
    public List<Customer> getAllList(Connection conn) {
        ...
        List<Customer> list = getAll(conn,sql);
        return list;
    }
    ...
    @Override
    public Date getMinBirth(Connection conn) {
